...
func _init() -> void:
	...
	field.blend_rect(car, Rect2i(0, 0, car.get_width(), car.get_height()), Vector2i(318, 378))
	field.blend_rect(car, Rect2i(0, 0, car.get_width(), car.get_height()), Vector2i(300, 408))
	...
	_stamp_fighter(field, mako, "ultimate", 9, 700, 430, false)
