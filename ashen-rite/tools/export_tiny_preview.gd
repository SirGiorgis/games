...
func _init() -> void:
	...
	_stamp_fighter(field, chris, "idle", 0, 180, 620, false)
	_stamp_fighter(field, mako, "idle", 0, 380, 620, false)
	_stamp_fighter(field, giannis, "ultimate", 10, 600, 620, false)
	_stamp_fighter(field, fogas, "idle", 0, 860, 620, false)
	_stamp_fighter(field, giorgis, "idle", 0, 1100, 620, true)
