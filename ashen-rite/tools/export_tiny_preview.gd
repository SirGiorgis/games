...
func _init() -> void:
	...
	var vag := _def("vag")
	_stamp_fighter(field, chris, "idle", 0, 110, 620, false)
	_stamp_fighter(field, mako, "idle", 0, 310, 620, false)
	_stamp_fighter(field, vag, "ultimate", 8, 520, 620, false)
	_stamp_fighter(field, fogas, "idle", 0, 740, 620, false)
	_stamp_fighter(field, giannis, "idle", 0, 960, 620, false)
